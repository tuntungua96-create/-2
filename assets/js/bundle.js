  ...
  function initHomeCanvas() {
    ...
    class Plane extends THREE.Object3D {
      ...
      resize() {
        ...
        this.xOffset = (left + (width / 2)) - (ww / 2) - 10;
    ...
    class Core {
      ...
      resize = () => {
        ...
        const zoom = window.__zoomVal !== undefined ? window.__zoomVal : 1;
        this.camera.left = (ww / -2) * zoom;
        this.camera.right = (ww / 2) * zoom;
        this.camera.top = (wh / 2) * zoom;
        this.camera.bottom = (wh / -2) * zoom;
        this.camera.updateProjectionMatrix();
    ...
    homeCanvasCleanup = () => {
      ...
      if (core) {
        ...
        window.removeEventListener('resize', core._debouncedResize);
